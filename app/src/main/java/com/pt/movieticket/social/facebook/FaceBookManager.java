...
public class FaceBookManager implements IFacebookConfig {
    ...
    private static final String GET_AVATAR = "https://graph.facebook.com/%s/picture?type=large";
     ...
     */
    public static void registerCallback(final ICallbackLoginFacebook callbackLogin) {
        ...
        new GraphRequest(
                ...
                new GraphRequest.Callback() {
                    public void onCompleted(GraphResponse response) {
                        ...
                        user.setAvatar(String.format(GET_AVATAR, user.getId()));
