...
public class DateTimeUtility {
    ...
    private static final String DEFAULT_FORMAT_SELECT_DATE = "EEEE, dd MMMM";
    ...
    public static String getToday() {
        ...
        SimpleDateFormat df = new SimpleDateFormat(DEFAULT_FORMAT_DATE, Locale.getDefault());
 ...
 */
    ...
    public static String getSelectDate(int year, int month, int day) {
        SimpleDateFormat dateFormat = new SimpleDateFormat(DEFAULT_FORMAT_DATE);
